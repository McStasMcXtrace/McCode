...
docker run -u docker -ti -e QT_X11_NO_MITSHM=1 -e DISPLAY=${DISPLAY_TO_USE} -v $XSOCK:$XSOCK -v $XAUTH:$XAUTH -v $HOME/McStas-dockers:/home/docker -e XAUTHORITY=$XAUTH $DEVICESTRING $containername mcstas-3.0-environment
