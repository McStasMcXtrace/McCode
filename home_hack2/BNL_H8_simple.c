 ...
 * Date:       Tue Oct 22 16:22:20 2019
 * File:       BNL_H8_simple.c
 * CFLAGS=
 */

#define MCCODE_STRING "McStas 3.0-dev - Oct. 22, 2019"
...
#ifndef MCCODE_DATE
#  define MCCODE_DATE "Oct. 22, 2019"
#endif
...
#  ifdef RNG_ALG==1
#    define randstate_t unsigned long
#    define RANDSTATE_LEN 4
#    define random mt_srandom
#    define srandom mt_random
#  elif RNG_ALG==2
#  elif RNG_ALG==3
#  endif
#endif
...
// Mersenne Twister (TODO: change state into an argument, enabling gpu usage)
