...
macro(setup_mccode_mkdist FLAVOR)
  ...
  if(NOT DEFINED INSTR_SUFFIX)
    if(DEFINED EXE_SUFFIX)
      set(INSTR_SUFFIX "${EXE_SUFFIX}")
    else()
      set(INSTR_SUFFIX "out")
    endif()
  endif()
  ...
  if(NOT DEFINED DOT_INSTR_SUFFIX AND NOT ${INSTR_SUFFIX} STREQUAL "")
    set(DOT_INSTR_SUFFIX ".${INSTR_SUFFIX}")
  endif()
