...
/* CUDA */
  ...
  for (unsigned long long Xmcrun_num=0 ; Xmcrun_num < 128 ; Xmcrun_num++) {
    _detector->_parameters.L_N[Xmcrun_num]=myL_N[Xmcrun_num];
    _detector->_parameters.L_p[Xmcrun_num]=myL_p[Xmcrun_num];
    _detector->_parameters.L_p2[Xmcrun_num]=myL_p2[Xmcrun_num];
  }
