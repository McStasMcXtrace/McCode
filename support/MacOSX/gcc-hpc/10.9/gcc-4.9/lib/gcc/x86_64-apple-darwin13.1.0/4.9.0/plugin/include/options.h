...
enum opt_code
{
  ...
  OPT_fgnu89_inline = 683,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 684,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 685,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 686,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 687,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 688,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 689,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 690,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 691,                       /* -fgraphite */
  OPT_fgraphite_identity = 692,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 693,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 694, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 695, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 696,           /* -fhash-synchronization */
  /* OPT_fhelp = 697, */                     /* -fhelp */
  ...
  OPT_findirect_classes = 711,               /* -findirect-classes */
  OPT_findirect_dispatch = 712,              /* -findirect-dispatch */
  OPT_findirect_inlining = 713,              /* -findirect-inlining */
  OPT_findirect_virtual_calls = 714,         /* -findirect-virtual-calls */
  OPT_finhibit_size_directive = 715,         /* -finhibit-size-directive */
  OPT_finit_character_ = 716,                /* -finit-character= */
  OPT_finit_integer_ = 717,                  /* -finit-integer= */
  OPT_finit_local_zero = 718,                /* -finit-local-zero */
  OPT_finit_logical_ = 719,                  /* -finit-logical= */
  OPT_finit_real_ = 720,                     /* -finit-real= */
  OPT_finline = 721,                         /* -finline */
  OPT_finline_atomics = 722,                 /* -finline-atomics */
  OPT_finline_functions = 723,               /* -finline-functions */
  OPT_finline_functions_called_once = 724,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 725, */            /* -finline-limit- */
  OPT_finline_limit_ = 726,                  /* -finline-limit= */
  OPT_finline_small_functions = 727,         /* -finline-small-functions */
  OPT_finput_charset_ = 728,                 /* -finput-charset= */
  OPT_finstrument_functions = 729,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 730,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 731,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 732,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 733,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 734,        /* -fintrinsic-modules-path= */
  ...
  OPT_fipa_sem_equality = 742,               /* -fipa-sem-equality */
  ...
  OPT_sub_library = 1377,                    /* -sub_library */
  OPT_sub_umbrella = 1378,                   /* -sub_umbrella */
  OPT_symbolic = 1379,                       /* -symbolic */
  OPT_t = 1380,                              /* -t */
  OPT_time = 1381,                           /* -time */
  OPT_time_ = 1382,                          /* -time= */
  ...
  OPT_twolevel_namespace = 1386,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 1387,       /* -twolevel_namespace_hints */
  OPT_u = 1388,                              /* -u */
  /* OPT_umbrella = 1389, */                 /* -umbrella */
  OPT_undef = 1390,                          /* -undef */
  OPT_undefined = 1391,                      /* -undefined */
  /* OPT_unexported_symbols_list = 1392, */  /* -unexported_symbols_list */
  OPT_v = 1393,                              /* -v */
  OPT_version = 1394,                        /* -version */
  OPT_w = 1395,                              /* -w */
  /* OPT_weak_reference_mismatches = 1396, *//* -weak_reference_mismatches */
  OPT_whatsloaded = 1397,                    /* -whatsloaded */
  OPT_whyload = 1398,                        /* -whyload */
  OPT_wrapper = 1399,                        /* -wrapper */
  OPT_x = 1400,                              /* -x */
  OPT_y = 1401,                              /* -y */
  OPT_z = 1402,                              /* -z */
  N_OPTS,
