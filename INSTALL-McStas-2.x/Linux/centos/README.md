# Installing McStas 2.7 on CentOS 
...
If you want to attempt installing our RPM packages manually via rpm -i, the packages are available for download at http://download.mcstas.org/current/linux/mcstas-2.7-rpm64-Centos_7.7/
