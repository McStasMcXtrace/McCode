...
##  IMPORTANT B:
* Please install [strawberry-perl-5.26.3.1-64bit.msi](https://download.mcstas.org/mcstas-2.7.1/windows/strawberry-perl-5.26.3.1-64bit.msi)
BEFORE  attempting to install the McStas metapackage!!!

## IMPORTANT C:
* Please install the [McStas 2.7.1 metapackage](https://download.mcstas.org/mcstas-2.7.1/windows/McStas-Metapackage-2.7.1-win64.exe)

* The [extras](https://download.mcstas.org/mcstas-2.7.1/windows/extras)
