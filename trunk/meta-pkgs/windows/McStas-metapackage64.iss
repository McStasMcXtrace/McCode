...
#define MyAppName "McStas Application bundle - Perl version"
...
Source: "dist\mcstas-tools-python-mcrun-NSIS-@VERSION@-mingw64.exe"; DestDir: "{tmp}"
Source: "dist\mcstas-tools-python-mcplot-chaco-NSIS-@VERSION@-mingw64.exe"; DestDir: "{tmp}"
Source: "dist\mcstas-tools-python-mcplot-matplotlib-NSIS-@VERSION@-mingw64.exe"; DestDir: "{tmp}"
Source: "dist\mcstas-tools-python-mcdisplay-NSIS-@VERSION@-mingw64.exe"; DestDir: "{tmp}"
...
Filename: "{tmp}\mcstas-tools-python-mcrun-NSIS-@VERSION@-mingw64.exe"; Parameters: "/S"
Filename: "{tmp}\mcstas-tools-python-mcplot-chaco-NSIS-@VERSION@-mingw64.exe"; Parameters: "/S"
Filename: "{tmp}\mcstas-tools-python-mcplot-matplotlib-NSIS-@VERSION@-mingw64.exe"; Parameters: "/S"
Filename: "{tmp}\mcstas-tools-python-mcdisplay-NSIS-@VERSION@-mingw64.exe"; Parameters: "/S"
