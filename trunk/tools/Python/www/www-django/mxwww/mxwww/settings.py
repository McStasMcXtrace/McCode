# Django settings for mxwww project.
...
## BEGIN McXtrace configuration; What you need is probably in this block!
...
DATABASES = {
    'default': {
        ...
        'NAME': './DB/mxwww.sqlite3',    # Or path to database file if using sqlite3.
