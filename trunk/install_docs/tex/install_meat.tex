...
\noindent To use grid and cluster computing, you will need an SSH client. \MCS\ is configured to 
use PuTTY.
...
\item{Optionally, as root, issue the command \\\verb+apt-get install openssh-client openssh-server mpich-bin libmpich1.0c2 libmpich1.0-dev+ to benefit from MPI and SSH grid parallelization}
