...
\item{Optionally, as root, issue the command \\\verb+apt-get install gcc-4.2 mpich-bin libmpich1.0c2 libmpich1.0-dev+ to benefit from MPI and OpenMP parallelization}
...
\noindent Additionally, MPICH, OpenMP (gcc-4.2 or icc or pgcc), Octave/Gnuplot, HDF and NeXus libraries may be installed, to enhance McStas clustering method and data formats.
...
\noindent To specify a non standard C compiler that supports OpenMP (e.g. gcc-4.2 or icc), you may use e.g.: ./configure --with-cc=gcc-4.2
