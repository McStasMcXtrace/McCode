...
\item{Scilab (Unix/Win32/Mac...) - a free 'Matlab-like' package, available from
    \htmladdnormallink{http://www-rocq.inria.fr/scilab/}{http://www-rocq.inria.fr/scilab/}. McStas also requires the Plolib library from \\ \htmladdnormallink{http://www.dma.utc.fr/$\sim$mottelet/myplot.html}{http://www.dma.utc.fr/~mottelet/myplot.html}.}
\end{itemize}
