...
\begin{itemize}
\item \textbf{rand01}(). Returns a random number distributed uniformly between 0 and 1.
\item \textbf{randnorm}(). Returns a random number from a normal
...
\item \textbf{randpm1}(). Returns a random number distributed uniformly between -1 and 1.
\item \textbf{randtriangle}(). Returns a random number from a triangular distribution between -1 and 1.
\item \textbf{randvec\_target\_circle}(\&$v_x$, \&$v_y$, \&$v_z$, \&$d\Omega$,
  ...
  (which still works).
\item \textbf{randvec\_target\_rect\_angular}(\&$v_x$, \&$v_y$, \&$v_z$,
...
\item \textbf{randvec\_target\_rect}(\&$v_x$, \&$v_y$, \&$v_z$,
