...
Source: "dist\mcstas-tools-python-mclib-NSIS-@VERSION@-mingw32.exe"; DestDir: "{tmp}"
...
Filename: "{tmp}\mcstas-tools-python-mclib-NSIS-@VERSION@-mingw32.exe"; Parameters: "/S"
