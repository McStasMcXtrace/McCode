...
#define MyAppName "McXtrace Application bundle - Perl version"
...
[Files]
Source: "Support\strawberry-perl-5.16.3.1-64bit.msi"; DestDir: "{tmp}"
...
[Run]
Filename: "msiexec"; Parameters: "/i {tmp}\strawberry-perl-5.16.3.1-64bit.msi"
