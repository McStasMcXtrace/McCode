...
Buildroot: %{buildroot}
Requires:  mcstas-@VERSION@ mcstas-comps-@VERSION@ mcstas-ncrystal-@VERSION@ mcstas-tools-perl-@VERSION@ mcstas-tools-perl-cmdline-@VERSION@ mcstas-manuals-@VERSION@
