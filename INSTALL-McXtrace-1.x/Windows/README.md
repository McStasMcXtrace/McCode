# Installation of McXtrace 1.7.1 on Windows 64 bit systems
...
##  IMPORTANT B:
* Please install the [McXtrace 1.7.1 metapackage](http://download.mcxtrace.org/current-classic/windows/McXtrace-Metapackage-1.7.1-win64.exe)
