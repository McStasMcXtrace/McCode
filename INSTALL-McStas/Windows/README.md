# Installation of McStas 2.6 on Windows 64 bit systems
...
## IMPORTANT C:
* Please install the [McStas 2.6 metapackage](http://download.mcstas.org/current/windows/McStas-Metapackage-2.6-win64.exe)
