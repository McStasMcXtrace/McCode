# Installation of McStas 3.5.0 on Windows 64 bit systems - using WSL
...
## Install the McStas 3.5.0 Debian packages
* Follow the
...
* Set the BROWSER="wslview" in your /usr/share/mcstas/3.5.0/tools/Python/mccodelib/mccode_config.py
