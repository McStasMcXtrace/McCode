  ...
  float getIq(float q, float qx, float qy, float pars[])
  {
    ...
    #endif
    #if model_index == 45
      Iq_out = Iq(q, pars[0], pars[1], pars[2], pars[3], pars[4], pars[5], pars[6], pars[7], pars[8], pars[9], pars[10], pars[11], pars[12], pars[13], pars[14], pars[15], pars[16], pars[17], pars[18], pars[19], pars[20], pars[21], pars[22], pars[23], pars[24], pars[25], pars[26]);
    #endif
    #if model_index == 46
      Iq_out = Iqxy(qx, qy, pars[0], pars[1], pars[2], pars[3], pars[4], pars[5], pars[6], pars[7], pars[8], pars[9], pars[10], pars[11], pars[12], pars[13], pars[14], pars[15], pars[16], pars[17], pars[18], pars[19], pars[20], pars[21], pars[22], pars[23], pars[24], pars[25], pars[26]);
    #endif
    #if model_index == 47
      Iq_out = Iq(q, pars[0], pars[1], pars[2]);
    #endif
