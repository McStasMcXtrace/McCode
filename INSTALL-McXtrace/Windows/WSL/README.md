# Installation of McXtrace 3.5.12 on Windows 64 bit systems - using WSL
...
## Install the McXtrace 3.5.12 Debian packages
* Follow the
...
* Set the BROWSER="wslview" in your /usr/share/mcxtrace/3.5.12/tools/Python/mccodelib/mccode_config.py
