...
import { initializeScene, initializeCamera, initializeRenderer, initializeGrids, initializeControls, initializeDirectionalLight, initializeAmbientLight } from './utils/initializeScene';
