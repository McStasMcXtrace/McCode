...
Some ui classes are autogenerated (do not edit).
...
NOTE: ALL explicit ui widget updates MUST be handled by this class
'''
class McView(object):
    def __init__(self):
        self.__mw = McMainWindow()
        self.mwui = self.__mw.ui
        # TODO: design and impl edit instrument window, and set it here
    ...
    def showOpenInstrumentDlg(self):
        ...
        instrumentFile = dlg.getOpenFileName()
        if instrumentFile:
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.edtWorkingDir = QtGui.QLineEdit(self.groupBox_2)
        self.edtWorkingDir.setObjectName("edtWorkingDir")
        self.gridLayout.addWidget(self.edtWorkingDir, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.tbtnWorkDir, 1, 3, 1, 1)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("run-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionRS.setIcon(icon)
        self.actionRS.setObjectName("actionRS")
        self.actionCS = QtGui.QAction(MainWindow)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("compile-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.edtWorkingDir.setToolTip(QtGui.QApplication.translate("MainWindow", "Update path and press enter", None, QtGui.QApplication.UnicodeUTF8))
