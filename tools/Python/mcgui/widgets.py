...
class Ui_dlgStartSim(object):
    def setupUi(self, dlgStartSim):
        ...
        self.gridSim.addWidget(self.edtSteps, 4, 2, 1, 1)
        ...
        self.gridSim.addWidget(self.edtNeutronCnt, 2, 2, 1, 1)
        ...
        self.gridSim.addWidget(self.edtNodes, 9, 2, 1, 1)
        ...
        self.cbxClustering.addItem("")
        self.cbxClustering.addItem("")
        self.gridSim.addWidget(self.cbxClustering, 6, 2, 1, 1)
        self.edtOutputDir = QtGui.QLineEdit(self.gbxSim)
        self.edtOutputDir.setObjectName("edtOutputDir")
        self.gridSim.addWidget(self.edtOutputDir, 3, 2, 1, 1)
