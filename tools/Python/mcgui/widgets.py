...
class Ui_dlgStartSim(object):
    def setupUi(self, dlgStartSim):
        ...
        self.gridSim.addWidget(self.cbxAutoPlot, 3, 2, 1, 1)
        ...
        self.label = QtWidgets.QLabel(self.gbxSim)
        self.label.setObjectName("label")
        self.gridSim.addWidget(self.label, 2, 1, 1, 1)
    ...
    def retranslateUi(self, dlgStartSim):
        ...
        self.label.setText(_translate("dlgStartSim", "McDisplay"))
