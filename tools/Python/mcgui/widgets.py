...
Some .ui files containing no logics are created and edited using qtcreator, then transformed into python.
...
NOTE: This file was initially hand-edited during the transition to PyQt5.
'''
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QtWidgets.QApplication.translate("MainWindow", "mcgui-py", None))
        self.gbxInstrument.setTitle(QtWidgets.QApplication.translate("MainWindow", "Instrument:", None))
        self.lblInstrument.setText(QtWidgets.QApplication.translate("MainWindow", "<Instrument file>", None))
        self.btnRun.setText(QtWidgets.QApplication.translate("MainWindow", "Run...", None))
        self.btnPlot.setText(QtWidgets.QApplication.translate("MainWindow", "Plot", None))
        self.btnEdit.setText(QtWidgets.QApplication.translate("MainWindow", "Edit", None))
        self.btnOpenInstrument.setToolTip(QtWidgets.QApplication.translate("MainWindow", "Browse instrument...", None))
        self.btnOpenInstrument.setText(QtWidgets.QApplication.translate("MainWindow", "Open...", None))
        self.gbxMessages.setTitle(QtWidgets.QApplication.translate("MainWindow", "Messages:", None))
        self.menuFile.setTitle(QtWidgets.QApplication.translate("MainWindow", "File", None))
        self.menuNew_From_Template.setTitle(QtWidgets.QApplication.translate("MainWindow", "New From Template...", None))
        self.menuSimulation.setTitle(QtWidgets.QApplication.translate("MainWindow", "Simulation", None))
        self.menuHelp.setTitle(QtWidgets.QApplication.translate("MainWindow", "Help", None))
        self.actionOpen_instrument.setText(QtWidgets.QApplication.translate("MainWindow", "Open...", None))
        self.actionOpen_instrument.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+O", None))
        ...
        self.actionRun_Simulation.setText(QtWidgets.QApplication.translate("MainWindow", "Run Simulation...", None))
        self.actionRun_Simulation.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+R", None))
        self.actionCompile_Instrument.setText(QtWidgets.QApplication.translate("MainWindow", "Compile Instrument", None))
        self.actionCompile_Instrument.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+Shift+R", None))
        self.actionMcstas_User_Manual.setText(QtWidgets.QApplication.translate("MainWindow", "mcstas User Manual", None))
        self.actionMcstas_Web_Page.setText(QtWidgets.QApplication.translate("MainWindow", "mcstas Web Page", None))
        self.actionAbout.setText(QtWidgets.QApplication.translate("MainWindow", "About...", None))
        self.actionAbout.setShortcut(QtWidgets.QApplication.translate("MainWindow", "F1", None))
        self.actionMcstas_Component_Manual.setText(QtWidgets.QApplication.translate("MainWindow", "mcstas Component Manual", None))
        self.actionNew_Instrument.setText(QtWidgets.QApplication.translate("MainWindow", "New Instrument...", None))
        self.actionNew_Instrument.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+N", None))
        self.actionEdit_Instrument.setText(QtWidgets.QApplication.translate("MainWindow", "Edit...", None))
        self.actionEdit_Instrument.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+E", None))
        self.actionClose_Instrument.setText(QtWidgets.QApplication.translate("MainWindow", "Close Instrument", None))
        self.actionClose_Instrument.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+W", None))
        self.actionPlot.setText(QtWidgets.QApplication.translate("MainWindow", "Plot", None))
        self.actionPlot.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+P", None))
        ...
        self.actionTempl_submenu.setText(QtWidgets.QApplication.translate("MainWindow", "new_from_templ_submenu", None))
        self.actionConfiguration.setText(QtWidgets.QApplication.translate("MainWindow", "Configuration...", None))
        self.actionConfiguration.setToolTip(QtWidgets.QApplication.translate("MainWindow", "mccode configuration", None))
        self.actionCompile_Instrument_MPI.setText(QtWidgets.QApplication.translate("MainWindow", "Compile Instrument (MPI)", None))
        self.actionMcdoc.setText(QtWidgets.QApplication.translate("MainWindow", "mcdoc Component Reference", None))
        self.actionDisplay.setText(QtWidgets.QApplication.translate("MainWindow", "Display-3D", None))
        self.actionDisplay_2d.setText(QtWidgets.QApplication.translate("MainWindow", "Display-2D", None))
        self.actionPlotOther.setText(QtWidgets.QApplication.translate("MainWindow", "Plot Other Results", None))
        self.actionPlotOther.setShortcut(QtWidgets.QApplication.translate("MainWindow", "Ctrl+Shift+P", None))
