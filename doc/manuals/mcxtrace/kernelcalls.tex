...
\item {\bfseries PROP\_X0,PROP\_Y0}. These macros are analogous to \verb+PROP_Z0+ except they propaget to the $x=0$ and $y=0$ planes respectively.

\item {\bfseries PROP\_DL}$(dl)$. Propagates the x-ray by the length $dl$, adjusting $(x,y,z)$ and $\phi$ accordingly,
...
\item {\bfseries STORE\_XRAY}$(index, x, y, z, kx, ky, kz, phi$, $Ex, Ey,
...
instrument.
\item {\bfseries RESTORE\_XRAY}$(index, x, y, z, kx, ky, kz, phi, Ex, Ey,
...
{\bfseries Monochromator\_curved} or {\bfseries Virtual\_input}
