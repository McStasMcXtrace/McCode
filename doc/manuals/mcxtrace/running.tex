...
compiled. It defaults to \fxwarning{correct this path}\verb+/usr/local/lib/mcxtrace+ on Unix-like systems and \verb+C:\mcxtrace\lib+ on Windows systems, but it can be
changed to something else, see \cref{c:install} for
