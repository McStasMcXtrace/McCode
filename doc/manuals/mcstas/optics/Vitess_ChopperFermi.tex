...
%\component{Vitess\_ChopperFermi}{Geza Zsigmond}{GeomOption, $N_\textrm{chan}$, $f$, $h$, $w_\textrm{tot}$, $l$, $r_\textrm{curv}$, $d$, $\phi$, $w_\textrm{wall}$, GeomFile}{zerotime, $N_\textrm{gates}$}{validated}
