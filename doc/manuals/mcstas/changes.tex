...
The following changes concern the 'Kernel' (i.e. the \MCS meta-language and program). See the dedicated chapter for more details \ref{c:kernel}.
...
\begin{itemize}
\item Manual and component manual updated 
\end{itemize}
...
\item From release 1.12, \MCS is GPL 2 only. The debate on the internet about the GPL 3 license suggests that this license 
     might have implications on the 'derived work', hence have implications on what and how our users use their \MCS simulations
