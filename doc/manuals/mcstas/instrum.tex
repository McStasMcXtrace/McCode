...
Figure \ref{f:2t_ab}a shows a scan of
...
\begin{figure}[tbp!]
  \begin{center}
    \includegraphics[width=0.47\textwidth]{figures/tas1-2T.eps}
    \hfill
    \includegraphics[width=0.47\textwidth]{figures/vanadium-plot-2.eps}
  \end{center}
\caption{TAS1. (a) Scans of $2\theta_s$ in the direct beam with 1 mm slit on the
  sample position.
"$\times$": measurements, "o": simulations, scaled to the same intensity.
Collimations: open-30'-open-open.
(b) Corrected $2\theta_a$ scan on a V-sample.
Collimations: open-30'-28'-67'. Symbols as before.}
\label{f:2t_ab}
\end{figure}
...
\begin{figure}[tbp!]
  \begin{center}
    \includegraphics[width=0.53\textwidth]{figures/al2o3-focus.eps}
  \end{center}
...
\begin{figure}[tbp!]
  \begin{center}
    \includegraphics[width=0.53\textwidth]{figures/ea-scan.eps}
  \end{center}
