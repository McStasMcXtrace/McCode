...
\begin{verbatim}
    mcgui
\end{verbatim}
The mcgui (mcgui.pl on Windows) program may optionally be given the name of an
instrument file.

\paragraph{Dependencies:}\index{Tools!PGPLOT} To use the \verb+mcgui+
...
When the front-end is started, a main window is opened (see figure
