...
distribution in /etc/apt/soources.list.) 

\noindent We also recommend to install octaga vrml viwer from
\htmladdnormallink{http://www.octaga.com/download_octaga.html}{http://www.octaga.com/download_octaga.html}
and scilab-4.0 from
\htmladdnormallink{http://www.scilab.org}{http://www.scilab.org}
