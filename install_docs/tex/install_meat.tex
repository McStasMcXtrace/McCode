...
\item{Scilab (Unix/Win32/Mac...) - a free 'Matlab-like' package, available from
    \htmladdnormallink{http://www.scilab.org/download/index_download.php?page=oldReleases.html}{http://www.scilab.org/download/index_download.php?page=oldReleases.html}.
