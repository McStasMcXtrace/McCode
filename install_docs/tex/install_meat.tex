...
\item{Win32:}
  ...
  \item{Get and install the ActivePerl package from\\
      \htmladdnormallink{http://downloads.activestate.com/ActivePerl/Windows/5.6/ActivePerl-5.6.1.638-MSWin32-x86.msi}{http://downloads.activestate.com/ActivePerl/Windows/5.6/ActivePerl-5.6.1.638-MSWin32-x86.msi}
...
\item{Unix/Linux:}
  \begin{itemize}
    ...
    \item{Consult the McStas webpage at \htmladdnormallink{http://www.mcstas.org}{http://www.mcstas.org} for updated links to the source code distributions.}
    \end{itemize}
  \end{itemize}
...
\item{Scilab (Unix/Win32/Mac...) - a free 'Matlab-like' package, available from
    \htmladdnormallink{http://www.scilab.org/download/index\_download.php?page=oldReleases.html}{http://www.scilab.org/download/index_download.php?page=oldReleases.html}.
...
website at
\htmladdnormallink{http://www.mcstas.org}{http://www.mcstas.org}, e.g.
\begin{itemize}
...
built, refer to the \htmladdnormallink{project website}{http://www.mcstas.org}.
...
\item{Compile the \htmladdnormallink{McStas}{http://www.mcstas.org} package using the \texttt{build.bat} script of the
