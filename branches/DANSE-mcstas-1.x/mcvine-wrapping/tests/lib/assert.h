...
#ifndef H_SIMULATION_COMMON_ASSERT
#define H_SIMULATION_COMMON_ASSERT
...
template <class Num1, class Num2>
void DANSE::Simulation::assertNumberEqual( Num1 a, Num2 b)
{
...
namespace DANSE{ namespace Simulation { namespace Assert {namespace impl_details{
...
template <class Num1, class Num2>
void DANSE::Simulation::assertNumberAlmostEqual
( Num1 a, Num2 b, double relerr, double abserr)
{
  using DANSE::Simulation::abs;
...
template <class Vector1, class Vector2>
void DANSE::Simulation::assertVectorAlmostEqual( const Vector1 & v1, const Vector2 & v2, double relerr, double abserr )
{
  if (v1.size() != v2.size()) {
...
#endif // H_SIMULATION_COMMON_ASSERT
