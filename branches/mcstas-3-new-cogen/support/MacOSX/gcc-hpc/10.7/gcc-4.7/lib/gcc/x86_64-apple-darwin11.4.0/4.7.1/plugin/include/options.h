...
#define MASK_MACHO_DYNAMIC_NO_PIC (1 << 8)
...
#define MASK_FLOAT_RETURNS (1 << 9)
#define OPTION_MASK_ISA_FSGSBASE (HOST_WIDE_INT_1 << 14)
#define MASK_IEEE_FP (1 << 10)
#define MASK_INLINE_ALL_STRINGOPS (1 << 11)
#define MASK_INLINE_STRINGOPS_DYNAMICALLY (1 << 12)
...
#define MASK_MS_BITFIELD_LAYOUT (1 << 13)
#define MASK_NO_ALIGN_STRINGOPS (1 << 14)
#define MASK_NO_FANCY_MATH_387 (1 << 15)
...
enum opt_code
{
  ...
  OPT_Wnonportable_cfstrings = 281,          /* -Wnonportable-cfstrings */
  ...
  OPT_Z = 394,                               /* -Z */
  OPT_Zall_load = 395,                       /* -Zall_load */
  OPT_Zallowable_client = 396,               /* -Zallowable_client */
  OPT_Zarch_errors_fatal = 397,              /* -Zarch_errors_fatal */
  OPT_Zbind_at_load = 398,                   /* -Zbind_at_load */
  OPT_Zbundle = 399,                         /* -Zbundle */
  OPT_Zbundle_loader = 400,                  /* -Zbundle_loader */
  OPT_Zdead_strip = 401,                     /* -Zdead_strip */
  OPT_Zdylib_file = 402,                     /* -Zdylib_file */
  OPT_Zdynamic = 403,                        /* -Zdynamic */
  OPT_Zdynamiclib = 404,                     /* -Zdynamiclib */
  OPT_Zexported_symbols_list = 405,          /* -Zexported_symbols_list */
  OPT_Zflat_namespace = 406,                 /* -Zflat_namespace */
  OPT_Zfn_seg_addr_table_filename = 407,     /* -Zfn_seg_addr_table_filename */
  OPT_Zforce_cpusubtype_ALL = 408,           /* -Zforce_cpusubtype_ALL */
  OPT_Zforce_flat_namespace = 409,           /* -Zforce_flat_namespace */
  OPT_Zimage_base = 410,                     /* -Zimage_base */
  OPT_Zinit = 411,                           /* -Zinit */
  OPT_Zinstall_name = 412,                   /* -Zinstall_name */
  OPT_Zmulti_module = 413,                   /* -Zmulti_module */
  OPT_Zmultiply_defined = 414,               /* -Zmultiply_defined */
  OPT_Zmultiplydefinedunused = 415,          /* -Zmultiplydefinedunused */
  OPT_Zno_dead_strip_inits_and_terms = 416,  /* -Zno_dead_strip_inits_and_terms */
  OPT_Zseg_addr_table = 417,                 /* -Zseg_addr_table */
  OPT_Zsegaddr = 418,                        /* -Zsegaddr */
  OPT_Zsegs_read_only_addr = 419,            /* -Zsegs_read_only_addr */
  OPT_Zsegs_read_write_addr = 420,           /* -Zsegs_read_write_addr */
  OPT_Zsingle_module = 421,                  /* -Zsingle_module */
  OPT_Zumbrella = 422,                       /* -Zumbrella */
  OPT_Zunexported_symbols_list = 423,        /* -Zunexported_symbols_list */
  OPT_Zweak_reference_mismatches = 424,      /* -Zweak_reference_mismatches */
  /* OPT_all_load = 425, */                  /* -all_load */
  /* OPT_allowable_client = 426, */          /* -allowable_client */
  OPT_ansi = 427,                            /* -ansi */
  OPT_arch = 428,                            /* -arch */
  /* OPT_arch_errors_fatal = 429, */         /* -arch_errors_fatal */
  OPT_aux_info = 430,                        /* -aux-info */
  /* OPT_aux_info_ = 431, */                 /* -aux-info= */
  OPT_auxbase = 432,                         /* -auxbase */
  OPT_auxbase_strip = 433,                   /* -auxbase-strip */
  /* OPT_bind_at_load = 434, */              /* -bind_at_load */
  /* OPT_bootclasspath = 435, */             /* -bootclasspath */
  /* OPT_bundle = 436, */                    /* -bundle */
  /* OPT_bundle_loader = 437, */             /* -bundle_loader */
  OPT_c = 438,                               /* -c */
  /* OPT_classpath = 439, */                 /* -classpath */
  OPT_client_name = 440,                     /* -client_name */
  OPT_compatibility_version = 441,           /* -compatibility_version */
  OPT_coverage = 442,                        /* -coverage */
  OPT_cpp = 443,                             /* -cpp */
  OPT_cpp_ = 444,                            /* -cpp= */
  OPT_current_version = 445,                 /* -current_version */
  OPT_d = 446,                               /* -d */
  /* OPT_dead_strip = 447, */                /* -dead_strip */
  /* OPT_dependency_file = 448, */           /* -dependency-file */
  OPT_dumpbase = 449,                        /* -dumpbase */
  OPT_dumpdir = 450,                         /* -dumpdir */
  OPT_dumpmachine = 451,                     /* -dumpmachine */
  OPT_dumpspecs = 452,                       /* -dumpspecs */
  OPT_dumpversion = 453,                     /* -dumpversion */
  /* OPT_dylib_file = 454, */                /* -dylib_file */
  OPT_dylinker = 455,                        /* -dylinker */
  OPT_dylinker_install_name = 456,           /* -dylinker_install_name */
  /* OPT_dynamic = 457, */                   /* -dynamic */
  /* OPT_dynamiclib = 458, */                /* -dynamiclib */
  OPT_e = 459,                               /* -e */
  /* OPT_encoding = 460, */                  /* -encoding */
  OPT_export_dynamic = 461,                  /* -export-dynamic */
  /* OPT_exported_symbols_list = 462, */     /* -exported_symbols_list */
  OPT_extdirs = 463,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 464, */               /* -fCLASSPATH= */
  OPT_fPIC = 465,                            /* -fPIC */
  OPT_fPIE = 466,                            /* -fPIE */
  OPT_fRTS_ = 467,                           /* -fRTS= */
  OPT_fabi_version_ = 468,                   /* -fabi-version= */
  OPT_faccess_control = 469,                 /* -faccess-control */
  OPT_faggressive_function_elimination = 470,/* -faggressive-function-elimination */
  ...
  OPT_fapple_kext = 485,                     /* -fapple-kext */
  ...
  OPT_fasm = 490,                            /* -fasm */
  OPT_fassert = 491,                         /* -fassert */
  OPT_fassociative_math = 492,               /* -fassociative-math */
  OPT_fassume_compiled = 493,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 494,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 495,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 496,                   /* -fauto-inc-dec */
  ...
  OPT_fcheck_references = 519,               /* -fcheck-references */
  OPT_fcheck_ = 520,                         /* -fcheck= */
  OPT_fclasspath_ = 521,                     /* -fclasspath= */
  OPT_fcoarray_ = 522,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 523,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 524,                         /* -fcommon */
  OPT_fcompare_debug = 525,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 526,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 527,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 528,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 529,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 530,                  /* -fcond-mismatch */
  OPT_fconserve_space = 531,                 /* -fconserve-space */
  OPT_fconserve_stack = 532,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 533,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 534,               /* -fconstexpr-depth= */
  OPT_fconvert_big_endian = 535,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 536,          /* -fconvert=little-endian */
  OPT_fconvert_native = 537,                 /* -fconvert=native */
  OPT_fconvert_swap = 538,                   /* -fconvert=swap */
  OPT_fcprop_registers = 539,                /* -fcprop-registers */
  OPT_fcray_pointer = 540,                   /* -fcray-pointer */
  OPT_fcrossjumping = 541,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 542,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 543, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 544,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 545,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 546,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 547,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 548,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 549,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 550,                       /* -fdbg-cnt= */
  OPT_fdce = 551,                            /* -fdce */
  OPT_fdebug_cpp = 552,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 553,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 554,            /* -fdebug-types-section */
  OPT_fdeduce_init_list = 555,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 556,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 557, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 558,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 559,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 560,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 561,                 /* -fdelayed-branch */
  OPT_fdelete_null_pointer_checks = 562,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 563,                   /* -fdevirtualize */
  OPT_fdiagnostics_show_location_ = 564,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 565,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 566,                /* -fdirectives-only */
  OPT_fdisable_ = 567,                       /* -fdisable- */
  OPT_fdisable_assertions = 568,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 569,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 570,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 571,         /* -fdollars-in-identifiers */
  OPT_fdse = 572,                            /* -fdse */
  OPT_fdump_ = 573,                          /* -fdump- */
  /* OPT_fdump_core = 574, */                /* -fdump-core */
  OPT_fdump_final_insns = 575,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 576,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 577,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 578,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 579,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 580,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 581,                /* -fdump-parse-tree */
  OPT_fdump_passes = 582,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 583,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 584,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 585,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 586,                 /* -fearly-inlining */
  OPT_felide_constructors = 587,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 588,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 589, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 590,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 591,        /* -femit-class-debug-always */
  OPT_femit_class_file = 592,                /* -femit-class-file */
  OPT_femit_class_files = 593,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 594,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 595,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 596,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 597,                        /* -fenable- */
  OPT_fenable_assertions = 598,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 599,             /* -fenable-assertions= */
  OPT_fencoding_ = 600,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 601,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 602, */           /* -fenum-int-equiv */
  OPT_fexceptions = 603,                     /* -fexceptions */
  OPT_fexcess_precision_ = 604,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 605,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 606,        /* -fexpensive-optimizations */
  OPT_fextdirs_ = 607,                       /* -fextdirs= */
  OPT_fextended_identifiers = 608,           /* -fextended-identifiers */
  OPT_fexternal_blas = 609,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 610, */       /* -fexternal-templates */
  OPT_ff2c = 611,                            /* -ff2c */
  OPT_ffast_math = 612,                      /* -ffast-math */
  OPT_ffat_lto_objects = 613,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 614,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 615,               /* -ffinite-math-only */
  OPT_ffixed_ = 616,                         /* -ffixed- */
  OPT_ffixed_form = 617,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 618,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 619,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 620,                    /* -ffloat-store */
  OPT_ffor_scope = 621,                      /* -ffor-scope */
  /* OPT_fforce_addr = 622, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 623,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 624,              /* -fforward-propagate */
  OPT_ffp_contract_ = 625,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 626,                      /* -ffpe-trap= */
  OPT_ffree_form = 627,                      /* -ffree-form */
  OPT_ffree_line_length_ = 628,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 629,          /* -ffree-line-length-none */
  OPT_ffreestanding = 630,                   /* -ffreestanding */
  OPT_ffriend_injection = 631,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 632,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 633,                   /* -ffunction-cse */
  OPT_ffunction_sections = 634,              /* -ffunction-sections */
  OPT_fgcse = 635,                           /* -fgcse */
  OPT_fgcse_after_reload = 636,              /* -fgcse-after-reload */
  OPT_fgcse_las = 637,                       /* -fgcse-las */
  OPT_fgcse_lm = 638,                        /* -fgcse-lm */
  OPT_fgcse_sm = 639,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 640,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 641,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 642,                         /* -fgnu-tm */
  OPT_fgnu89_inline = 643,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 644,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 645,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 646,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 647,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 648,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 649,                     /* -fgo-prefix= */
  ...
  /* OPT_fhonor_std = 658, */                /* -fhonor-std */
  OPT_fhosted = 659,                         /* -fhosted */
  /* OPT_fhuge_objects = 660, */             /* -fhuge-objects */
  OPT_fident = 661,                          /* -fident */
  OPT_fif_conversion = 662,                  /* -fif-conversion */
  OPT_fif_conversion2 = 663,                 /* -fif-conversion2 */
  OPT_filelist = 664,                        /* -filelist */
  ...
  OPT_findirect_virtual_calls = 672,         /* -findirect-virtual-calls */
  OPT_finhibit_size_directive = 673,         /* -finhibit-size-directive */
  OPT_finit_character_ = 674,                /* -finit-character= */
  OPT_finit_integer_ = 675,                  /* -finit-integer= */
  OPT_finit_local_zero = 676,                /* -finit-local-zero */
  OPT_finit_logical_ = 677,                  /* -finit-logical= */
  OPT_finit_real_ = 678,                     /* -finit-real= */
  OPT_finline = 679,                         /* -finline */
  OPT_finline_atomics = 680,                 /* -finline-atomics */
  OPT_finline_functions = 681,               /* -finline-functions */
  OPT_finline_functions_called_once = 682,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 683, */            /* -finline-limit- */
  OPT_finline_limit_ = 684,                  /* -finline-limit= */
  OPT_finline_small_functions = 685,         /* -finline-small-functions */
  OPT_finput_charset_ = 686,                 /* -finput-charset= */
  OPT_finstrument_functions = 687,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 688,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 689,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 690,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 691,         /* -fintrinsic-modules-path */
  ...
  OPT_fira_loop_pressure = 702,              /* -fira-loop-pressure */
  OPT_fira_region_ = 703,                    /* -fira-region= */
  OPT_fira_share_save_slots = 704,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 705,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 706,                   /* -fira-verbose= */
  OPT_fivopts = 707,                         /* -fivopts */
  OPT_fjni = 708,                            /* -fjni */
  OPT_fjump_tables = 709,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 710,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 711,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 712,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 713, */                /* -flabels-ok */
  /* OPT_flat_namespace = 714, */            /* -flat_namespace */
  OPT_flax_vector_conversions = 715,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 716,             /* -fleading-underscore */
  OPT_floop_block = 717,                     /* -floop-block */
  OPT_floop_flatten = 718,                   /* -floop-flatten */
  OPT_floop_interchange = 719,               /* -floop-interchange */
  /* OPT_floop_optimize = 720, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 721,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 722,                /* -floop-strip-mine */
  OPT_flto = 723,                            /* -flto */
  OPT_flto_compression_level_ = 724,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 725,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 726,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 727,             /* -flto-partition=none */
  OPT_flto_report = 728,                     /* -flto-report */
  OPT_flto_ = 729,                           /* -flto= */
  OPT_fltrans = 730,                         /* -fltrans */
  OPT_fltrans_output_list_ = 731,            /* -fltrans-output-list= */
  OPT_fmain_ = 732,                          /* -fmain= */
  OPT_fmath_errno = 733,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 734,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 735,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 736,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 737,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 738,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 739,                     /* -fmem-report */
  OPT_fmerge_all_constants = 740,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 741,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 742,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 743,                /* -fmessage-length= */
  OPT_fmodule_private = 744,                 /* -fmodule-private */
  OPT_fmodulo_sched = 745,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 746,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 747,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 748,                  /* -fms-extensions */
  OPT_fmudflap = 749,                        /* -fmudflap */
  OPT_fmudflapir = 750,                      /* -fmudflapir */
  OPT_fmudflapth = 751,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 752, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 753, */                  /* -fnew-abi */
  OPT_fnext_runtime = 754,                   /* -fnext-runtime */
  OPT_fnil_receivers = 755,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 756,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 757,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 758, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 759,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 760,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 761,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 762,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 763,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 764,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 765,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 766,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 767,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 768,             /* -fomit-frame-pointer */
  OPT_fopenmp = 769,                         /* -fopenmp */
  ...
  /* OPT_force_cpusubtype_ALL = 776, */      /* -force_cpusubtype_ALL */
  /* OPT_force_flat_namespace = 777, */      /* -force_flat_namespace */
  ...
  OPT_fsingle_precision_constant = 884,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 885,               /* -fsource-filename= */
  OPT_fsource_ = 886,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 887,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 888,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 889,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 890, */                 /* -fsquangle */
  OPT_fstack_arrays = 891,                   /* -fstack-arrays */
  /* OPT_fstack_check = 892, */              /* -fstack-check */
  OPT_fstack_check_ = 893,                   /* -fstack-check= */
  OPT_fstack_limit = 894,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 895,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 896,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 897,                /* -fstack-protector */
  OPT_fstack_protector_all = 898,            /* -fstack-protector-all */
  OPT_fstack_usage = 899,                    /* -fstack-usage */
  OPT_fstats = 900,                          /* -fstats */
  OPT_fstore_check = 901,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 902, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 903,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 904,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 905,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 906, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 907,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 908,                    /* -fsyntax-only */
  OPT_ftabstop_ = 909,                       /* -ftabstop= */
  /* OPT_ftarget_help = 910, */              /* -ftarget-help */
  OPT_ftarget_ = 911,                        /* -ftarget= */
  /* OPT_ftemplate_depth_ = 912, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 913,                /* -ftemplate-depth= */
  OPT_fterminated_vtables = 914,             /* -fterminated-vtables */
  OPT_ftest_coverage = 915,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 916, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 917,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 918,             /* -fthreadsafe-statics */
  OPT_ftime_report = 919,                    /* -ftime-report */
  OPT_ftls_model_ = 920,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 921,               /* -ftoplevel-reorder */
  OPT_ftracer = 922,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 923,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 924,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 925,                  /* -ftrapping-math */
  OPT_ftrapv = 926,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 927,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 928,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 929,                       /* -ftree-ccp */
  OPT_ftree_ch = 930,                        /* -ftree-ch */
  ...
  OPT_ftree_phiprop = 949,                   /* -ftree-phiprop */
  OPT_ftree_pre = 950,                       /* -ftree-pre */
  OPT_ftree_pta = 951,                       /* -ftree-pta */
  OPT_ftree_reassoc = 952,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 953, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 954,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 955,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 956,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 957,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 958, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 959, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 960,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 961,                /* -ftree-tail-merge */
  OPT_ftree_ter = 962,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 963,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 964,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 965,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 966,                       /* -ftree-vrp */
  OPT_funderscoring = 967,                   /* -funderscoring */
  OPT_funit_at_a_time = 968,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 969,               /* -funroll-all-loops */
  OPT_funroll_loops = 970,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 971,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 972,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 973,             /* -funsigned-bitfields */
  OPT_funsigned_char = 974,                  /* -funsigned-char */
  OPT_funswitch_loops = 975,                 /* -funswitch-loops */
  OPT_funwind_tables = 976,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 977,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 978,                   /* -fuse-boehm-gc */
  ...
  OPT_fuse_linker_plugin = 982,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 983,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 984,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 985,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 986,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 987, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 988,                /* -fvect-cost-model */
  OPT_fverbose_asm = 989,                    /* -fverbose-asm */
  /* OPT_fversion = 990, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 991,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 992,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 993,                    /* -fvisibility= */
  OPT_fvpt = 994,                            /* -fvpt */
  /* OPT_fvtable_gc = 995, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 996, */            /* -fvtable-thunks */
  OPT_fweak = 997,                           /* -fweak */
  OPT_fweb = 998,                            /* -fweb */
  OPT_fwhole_file = 999,                     /* -fwhole-file */
  OPT_fwhole_program = 1000,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1001,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1002,             /* -fworking-directory */
  OPT_fwpa = 1003,                           /* -fwpa */
  OPT_fwrapv = 1004,                         /* -fwrapv */
  /* OPT_fxref = 1005, */                    /* -fxref */
  /* OPT_fzee = 1006, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1007,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1008,                     /* -fzero-link */
  OPT_g = 1009,                              /* -g */
  OPT_gant = 1010,                           /* -gant */
  OPT_gcoff = 1011,                          /* -gcoff */
  OPT_gdwarf_ = 1012,                        /* -gdwarf- */
  OPT_gen_decls = 1013,                      /* -gen-decls */
  OPT_gfull = 1014,                          /* -gfull */
  OPT_ggdb = 1015,                           /* -ggdb */
  OPT_gnat = 1016,                           /* -gnat */
  OPT_gnatO = 1017,                          /* -gnatO */
  OPT_gno_record_gcc_switches = 1018,        /* -gno-record-gcc-switches */
  OPT_gno_strict_dwarf = 1019,               /* -gno-strict-dwarf */
  ...
  OPT_gused = 1025,                          /* -gused */
  OPT_gvms = 1026,                           /* -gvms */
  OPT_gxcoff = 1027,                         /* -gxcoff */
  OPT_gxcoff_ = 1028,                        /* -gxcoff+ */
  OPT_h = 1029,                              /* -h */
  OPT_headerpad_max_install_names = 1030,    /* -headerpad_max_install_names */
  OPT_idirafter = 1031,                      /* -idirafter */
  OPT_iframework = 1032,                     /* -iframework */
  OPT_imacros = 1033,                        /* -imacros */
  /* OPT_image_base = 1034, */               /* -image_base */
  OPT_imultilib = 1035,                      /* -imultilib */
  OPT_include = 1036,                        /* -include */
  /* OPT_init = 1037, */                     /* -init */
  /* OPT_install_name = 1038, */             /* -install_name */
  ...
  OPT_k8 = 1046,                             /* -k8 */
  OPT_keep_private_externs = 1047,           /* -keep_private_externs */
  OPT_l = 1048,                              /* -l */
  OPT_lang_asm = 1049,                       /* -lang-asm */
  OPT_m128bit_long_double = 1050,            /* -m128bit-long-double */
  OPT_m32 = 1051,                            /* -m32 */
  OPT_m3dnow = 1052,                         /* -m3dnow */
  OPT_m3dnowa = 1053,                        /* -m3dnowa */
  OPT_m64 = 1054,                            /* -m64 */
  OPT_m80387 = 1055,                         /* -m80387 */
  OPT_m8bit_idiv = 1056,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1057,             /* -m96bit-long-double */
  OPT_mabi_ = 1058,                          /* -mabi= */
  OPT_mabm = 1059,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1060,      /* -maccumulate-outgoing-args */
  OPT_maes = 1061,                           /* -maes */
  OPT_malign_double = 1062,                  /* -malign-double */
  OPT_malign_functions_ = 1063,              /* -malign-functions= */
  OPT_malign_jumps_ = 1064,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1065,                  /* -malign-loops= */
  OPT_malign_stringops = 1066,               /* -malign-stringops */
  OPT_march_ = 1067,                         /* -march= */
  OPT_masm_ = 1068,                          /* -masm= */
  OPT_matt_stubs = 1069,                     /* -matt-stubs */
  OPT_mavx = 1070,                           /* -mavx */
  OPT_mavx2 = 1071,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1072,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1073,  /* -mavx256-split-unaligned-store */
  OPT_mbmi = 1074,                           /* -mbmi */
  OPT_mbmi2 = 1075,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1076,                  /* -mbranch-cost= */
  OPT_mcld = 1077,                           /* -mcld */
  OPT_mcmodel_ = 1078,                       /* -mcmodel= */
  OPT_mconstant_cfstrings = 1079,            /* -mconstant-cfstrings */
  /* OPT_mcpu_ = 1080, */                    /* -mcpu= */
  OPT_mcrc32 = 1081,                         /* -mcrc32 */
  OPT_mcx16 = 1082,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1083,            /* -mdispatch-scheduler */
  OPT_mdynamic_no_pic = 1084,                /* -mdynamic-no-pic */
  OPT_mf16c = 1085,                          /* -mf16c */
  OPT_mfancy_math_387 = 1086,                /* -mfancy-math-387 */
  OPT_mfentry = 1087,                        /* -mfentry */
  OPT_mfix_and_continue = 1088,              /* -mfix-and-continue */
  OPT_mfma = 1089,                           /* -mfma */
  OPT_mfma4 = 1090,                          /* -mfma4 */
  OPT_mforce_drap = 1091,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1092,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1093,                       /* -mfpmath= */
  OPT_mfsgsbase = 1094,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1095, */              /* -mfused-madd */
  OPT_mhard_float = 1096,                    /* -mhard-float */
  OPT_mieee_fp = 1097,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1098,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1099,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1100,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1101, */            /* -mintel-syntax */
  OPT_mkernel = 1102,                        /* -mkernel */
  OPT_mlarge_data_threshold_ = 1103,         /* -mlarge-data-threshold= */
  OPT_mlwp = 1104,                           /* -mlwp */
  OPT_mlzcnt = 1105,                         /* -mlzcnt */
  OPT_mmacosx_version_min_ = 1106,           /* -mmacosx-version-min= */
  OPT_mmmx = 1107,                           /* -mmmx */
  OPT_mmovbe = 1108,                         /* -mmovbe */
  OPT_mms_bitfields = 1109,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1110,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1111,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1112,                  /* -mno-push-args */
  OPT_mno_red_zone = 1113,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1114,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1115,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 1116,                 /* -mone-byte-bool */
  OPT_mpc32 = 1117,                          /* -mpc32 */
  OPT_mpc64 = 1118,                          /* -mpc64 */
  OPT_mpc80 = 1119,                          /* -mpc80 */
  OPT_mpclmul = 1120,                        /* -mpclmul */
  OPT_mpopcnt = 1121,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1122,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1123,     /* -mpreferred-stack-boundary= */
  OPT_mpush_args = 1124,                     /* -mpush-args */
  OPT_mrdrnd = 1125,                         /* -mrdrnd */
  OPT_mrecip = 1126,                         /* -mrecip */
  OPT_mrecip_ = 1127,                        /* -mrecip= */
  OPT_mred_zone = 1128,                      /* -mred-zone */
  OPT_mregparm_ = 1129,                      /* -mregparm= */
  OPT_mrtd = 1130,                           /* -mrtd */
  OPT_msahf = 1131,                          /* -msahf */
  OPT_msoft_float = 1132,                    /* -msoft-float */
  OPT_msse = 1133,                           /* -msse */
  OPT_msse2 = 1134,                          /* -msse2 */
  OPT_msse2avx = 1135,                       /* -msse2avx */
  OPT_msse3 = 1136,                          /* -msse3 */
  OPT_msse4 = 1137,                          /* -msse4 */
  OPT_msse4_1 = 1138,                        /* -msse4.1 */
  OPT_msse4_2 = 1139,                        /* -msse4.2 */
  OPT_msse4a = 1140,                         /* -msse4a */
  /* OPT_msse5 = 1141, */                    /* -msse5 */
  OPT_msseregparm = 1142,                    /* -msseregparm */
  OPT_mssse3 = 1143,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1144,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1145,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1146,            /* -mstringop-strategy= */
  OPT_mtbm = 1147,                           /* -mtbm */
  OPT_mtls_dialect_ = 1148,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1149,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1150,                         /* -mtune= */
  /* OPT_multi_module = 1151, */             /* -multi_module */
  /* OPT_multiply_defined = 1152, */         /* -multiply_defined */
  /* OPT_multiply_defined_unused = 1153, */  /* -multiply_defined_unused */
  OPT_mveclibabi_ = 1154,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1155,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1156,                    /* -mvzeroupper */
  OPT_mx32 = 1157,                           /* -mx32 */
  OPT_mxop = 1158,                           /* -mxop */
  OPT_n = 1159,                              /* -n */
  OPT_no_canonical_prefixes = 1160,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1161,              /* -no-integrated-cpp */
  /* OPT_no_dead_strip_inits_and_terms = 1162, *//* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 1163,                          /* -nocpp */
  OPT_nodefaultlibs = 1164,                  /* -nodefaultlibs */
  OPT_nofixprebinding = 1165,                /* -nofixprebinding */
  OPT_nomultidefs = 1166,                    /* -nomultidefs */
  OPT_noprebind = 1167,                      /* -noprebind */
  OPT_noseglinkedit = 1168,                  /* -noseglinkedit */
  OPT_nostartfiles = 1169,                   /* -nostartfiles */
  OPT_nostdinc = 1170,                       /* -nostdinc */
  OPT_nostdinc__ = 1171,                     /* -nostdinc++ */
  OPT_nostdlib = 1172,                       /* -nostdlib */
  OPT_o = 1173,                              /* -o */
  OPT_object = 1174,                         /* -object */
  OPT_p = 1175,                              /* -p */
  OPT_pagezero_size = 1176,                  /* -pagezero_size */
  OPT_pass_exit_codes = 1177,                /* -pass-exit-codes */
  OPT_pedantic = 1178,                       /* -pedantic */
  OPT_pedantic_errors = 1179,                /* -pedantic-errors */
  OPT_pg = 1180,                             /* -pg */
  OPT_pie = 1181,                            /* -pie */
  OPT_pipe = 1182,                           /* -pipe */
  OPT_prebind = 1183,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 1184,   /* -prebind_all_twolevel_modules */
  OPT_preload = 1185,                        /* -preload */
  ...
  OPT_private_bundle = 1196,                 /* -private_bundle */
  OPT_pthread = 1197,                        /* -pthread */
  OPT_quiet = 1198,                          /* -quiet */
  OPT_r = 1199,                              /* -r */
  OPT_read_only_relocs = 1200,               /* -read_only_relocs */
  OPT_remap = 1201,                          /* -remap */
  OPT_s = 1202,                              /* -s */
  OPT_s_bc_abi = 1203,                       /* -s-bc-abi */
  OPT_save_temps = 1204,                     /* -save-temps */
  OPT_save_temps_ = 1205,                    /* -save-temps= */
  OPT_sectalign = 1206,                      /* -sectalign */
  OPT_sectcreate = 1207,                     /* -sectcreate */
  OPT_sectobjectsymbols = 1208,              /* -sectobjectsymbols */
  OPT_sectorder = 1209,                      /* -sectorder */
  OPT_seg1addr = 1210,                       /* -seg1addr */
  /* OPT_seg_addr_table = 1211, */           /* -seg_addr_table */
  /* OPT_seg_addr_table_filename = 1212, */  /* -seg_addr_table_filename */
  /* OPT_segaddr = 1213, */                  /* -segaddr */
  OPT_segcreate = 1214,                      /* -segcreate */
  OPT_seglinkedit = 1215,                    /* -seglinkedit */
  OPT_segprot = 1216,                        /* -segprot */
  /* OPT_segs_read_only_addr = 1217, */      /* -segs_read_only_addr */
  /* OPT_segs_read_write_addr = 1218, */     /* -segs_read_write_addr */
  OPT_shared = 1219,                         /* -shared */
  OPT_shared_libgcc = 1220,                  /* -shared-libgcc */
  /* OPT_single_module = 1221, */            /* -single_module */
  /* OPT_specs = 1222, */                    /* -specs */
  OPT_specs_ = 1223,                         /* -specs= */
  OPT_static = 1224,                         /* -static */
  ...
  OPT_static_libstdc__ = 1229,               /* -static-libstdc++ */
  ...
  OPT_std_gnu__98 = 1248,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1249,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1250, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1251, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1252,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1253,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1254, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1255, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1256,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1257, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1258, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1259, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1260,                     /* -std=legacy */
  OPT_sub_library = 1261,                    /* -sub_library */
  OPT_sub_umbrella = 1262,                   /* -sub_umbrella */
  OPT_symbolic = 1263,                       /* -symbolic */
  OPT_t = 1264,                              /* -t */
  OPT_time = 1265,                           /* -time */
  OPT_time_ = 1266,                          /* -time= */
  OPT_traditional = 1267,                    /* -traditional */
  OPT_traditional_cpp = 1268,                /* -traditional-cpp */
  OPT_trigraphs = 1269,                      /* -trigraphs */
  OPT_twolevel_namespace = 1270,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 1271,       /* -twolevel_namespace_hints */
  OPT_u = 1272,                              /* -u */
  /* OPT_umbrella = 1273, */                 /* -umbrella */
  OPT_undef = 1274,                          /* -undef */
  OPT_undefined = 1275,                      /* -undefined */
  /* OPT_unexported_symbols_list = 1276, */  /* -unexported_symbols_list */
  OPT_v = 1277,                              /* -v */
  OPT_version = 1278,                        /* -version */
  OPT_w = 1279,                              /* -w */
  /* OPT_weak_reference_mismatches = 1280, *//* -weak_reference_mismatches */
  OPT_whatsloaded = 1281,                    /* -whatsloaded */
  OPT_whyload = 1282,                        /* -whyload */
