...
static Tk_OptionSpec labelOptionSpecs[] = {
    ...
    {TK_OPTION_SCALARVAR, "-textvariable", "textVariable", "Variable",
	DEF_BUTTON_TEXT_VARIABLE, -1, Tk_Offset(TkButton, textVarNamePtr),
	TK_OPTION_NULL_OK, 0, 0},
...
static Tk_OptionSpec buttonOptionSpecs[] = {
	...
	DEF_BUTTON_COMMAND, -1, Tk_Offset(TkButton, commandPtr),
	TK_OPTION_NULL_OK, 0, 0},
    {TK_OPTION_STRING_TABLE, "-compound", "compound", "Compound",
	 DEF_BUTTON_COMPOUND, -1, Tk_Offset(TkButton, compound), 0,
	 (ClientData) compoundStrings, 0},
...
static Tk_OptionSpec checkbuttonOptionSpecs[] = {
    ...
    {TK_OPTION_INT, "-underline", "underline", "Underline",
	DEF_BUTTON_UNDERLINE, -1, Tk_Offset(TkButton, underline), 0, 0, 0},
    {TK_OPTION_SCALARVAR, "-variable", "variable", "Variable",
	DEF_CHECKBUTTON_VARIABLE, -1, Tk_Offset(TkButton, selVarNamePtr),
	TK_OPTION_NULL_OK, 0, 0},
    {TK_OPTION_STRING, "-width", "width", "Width",
	DEF_BUTTON_WIDTH, Tk_Offset(TkButton, widthPtr), -1, 0, 0, 0},
    {TK_OPTION_PIXELS, "-wraplength", "wrapLength", "WrapLength",
...
static Tk_OptionSpec radiobuttonOptionSpecs[] = {
    ...
    {TK_OPTION_SCALARVAR, "-variable", "variable", "Variable",
	DEF_RADIOBUTTON_VARIABLE, -1, Tk_Offset(TkButton, selVarNamePtr),
	0, 0, 0},
    {TK_OPTION_STRING, "-width", "width", "Width",
	DEF_BUTTON_WIDTH, Tk_Offset(TkButton, widthPtr), -1, 0, 0, 0},
    {TK_OPTION_PIXELS, "-wraplength", "wrapLength", "WrapLength",
    ...
    TkButton *butPtr;		/* Info about button widget. */
{
	...
	Lang_UntraceVar(butPtr->interp, butPtr->textVarNamePtr,
	...
	Lang_UntraceVar(butPtr->interp, butPtr->selVarNamePtr,
		TCL_GLOBAL_ONLY|TCL_TRACE_WRITES|TCL_TRACE_UNSETS,
    ...
    Tcl_Obj *CONST objv[];	/* Argument values. */
{
    ...
    if (butPtr->textVarNamePtr != NULL) {
	Lang_UntraceVar(interp, butPtr->textVarNamePtr,
		TCL_GLOBAL_ONLY|TCL_TRACE_WRITES|TCL_TRACE_UNSETS,
		ButtonTextVarProc, (ClientData) butPtr);
    }
    if (butPtr->selVarNamePtr != NULL) {
	Lang_UntraceVar(interp, butPtr->selVarNamePtr,
		TCL_GLOBAL_ONLY|TCL_TRACE_WRITES|TCL_TRACE_UNSETS,
		ButtonVarProc, (ClientData) butPtr);
    }
    ...
    if (butPtr->textVarNamePtr != NULL) {
	Lang_TraceVar(interp, butPtr->textVarNamePtr,
		TCL_GLOBAL_ONLY|TCL_TRACE_WRITES|TCL_TRACE_UNSETS,
		ButtonTextVarProc, (ClientData) butPtr);
    }
    if (butPtr->selVarNamePtr != NULL) {
	Lang_TraceVar(interp, butPtr->selVarNamePtr,
		TCL_GLOBAL_ONLY|TCL_TRACE_WRITES|TCL_TRACE_UNSETS,
		ButtonVarProc, (ClientData) butPtr);
    }
    ...
    int flags;			/* Information about what happened. */
{
    ...
    valuePtr = Tcl_ObjGetVar2(interp, butPtr->selVarNamePtr, NULL, TCL_GLOBAL_ONLY);
    if (valuePtr == NULL) {
	value = "";
    } else {
    ...
    int flags;			/* Information about what happened. */
{
    ...
    if (flags & TCL_TRACE_UNSETS) {
	if ((flags & TCL_TRACE_DESTROYED) && !(flags & TCL_INTERP_DESTROYED)) {
	    Tcl_ObjSetVar2(interp, butPtr->textVarNamePtr, NULL, butPtr->textPtr,
		    TCL_GLOBAL_ONLY);
	    Lang_TraceVar(interp, butPtr->textVarNamePtr,
		    TCL_GLOBAL_ONLY|TCL_TRACE_WRITES|TCL_TRACE_UNSETS,
    ...
    valuePtr = Tcl_ObjGetVar2(interp, butPtr->textVarNamePtr, NULL, TCL_GLOBAL_ONLY);
    if (valuePtr == NULL) {
	valuePtr = Tcl_NewObj();
    }
    Tcl_DecrRefCount(butPtr->textPtr);
